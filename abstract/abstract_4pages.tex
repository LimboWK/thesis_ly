...
\hline
min\_all & Min VGA (whole property) \\
max\_all & Max VGA (whole property) \\
mean\_all & Mean VGA (whole property) \\
std\_all & Std VGA (whole property) \\
min\_lv & Min VGA (living room) \\
max\_lv & Max VGA (living room) \\
std\_lv & Std VGA (living room) \\
median\_lv & Median VGA (living room) \\
