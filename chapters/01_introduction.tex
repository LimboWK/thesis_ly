...
\subsection{Spatial Openness in Architectural Research}
...
Previous research has demonstrated that spatial openness influences occupant behavior, movement patterns, and 
...
samples, preventing generalization to broader urban contexts. Additionally, the tools and methodologies for 
systematically processing and analyzing large-scale visual and spatial data in housing research are still developing, 
creating both opportunities and challenges for comprehensive spatial analysis.
...
\textbf{Chapter 4: Comprehensive Openness Analysis} provides in-depth analysis including regression analysis against 
rent costs and detailed analysis of openness features, with image examples and comparison between 2D and 3D openness 
measures.

\textbf{Chapter 5: Discussion} interprets the results, discusses implications for architectural design and urban 
planning, addresses limitations, and suggests future research directions.

\textbf{Chapter 6: Conclusion} summarizes the key findings, contributions, and practical implications of the research.
...
This research contributes to the growing field of computational architecture and urban analytics by providing a 
systematic framework for understanding spatial openness in residential environments. The findings have implications 
for architectural design, urban planning, and real estate market analysis, offering data-driven insights that can 
inform more responsive and human-centered housing design practices.
