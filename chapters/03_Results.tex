...
The impact of construction decade on the openness indicators such as mean value of VGA heatmap in whole property and livining room
...
\subsubsection{Mean VGA of whole property}
\begin{table}[htbp]
    \centering
    ...
    \hline
    \end{tabular}
    \caption{Pairwise comparisons (Tukey HSD) for mean VGA of whole property across construction decades, showing mean differences, effect sizes, and statistical significance.}
...
mean VGA values with differences ranging from 4.88\% to 6.53\% compared to all subsequent decades. The 
...
\subsubsection{Mean VGA of living room}
\begin{table}[htbp]
    \centering
    \begin{tabular}{l|c|c|c|c|c|c}
    \hline
    ...
    \hline
    \end{tabular}
    \caption{Pairwise comparisons (Tukey HSD) for mean VGA of living room across construction decades, showing mean differences, effect sizes, and statistical significance.}
...
consistently demonstrate higher VGA values compared to all subsequent decades, with differences ranging 
...
\subsubsection{Standard deviation of VGA of whole property}
\begin{table}[htbp]
    \centering
    \begin{tabular}{l|c|c|c|c|c|c}
    \hline
    ...
    \hline
    \end{tabular}
    \caption{Pairwise comparisons (Tukey HSD) for standard deviation of VGA of whole property across construction decades, showing mean differences, effect sizes, and statistical significance.}
...
consistently show higher VGA standard deviation compared to all subsequent decades, with differences 
...
The spatial patterns of openness represented by overall and living room VGA mean values, 
...
Areas with high VGA values are scattered throughout the southern part of the city center and 
...
The relatively low VGA values in suburban areas are thought to be influenced by housing types 
...
the VGA mean value of the properties (7a). This finding suggests that floor plan openness and vertical spatial characteristics 
...
enclosed spaces for perhaps multiple bedrooms and bathrooms, creating a higher deivations in VGA values between small rooms
and large rooms.
...
\section{Impact of Housing indicators on Rental Prices}
...
\begin{table}[htbp]
    ...
    \hline
    \multirow{4}{*}{Whole Property 2D} & min\_value\_raw\_all & Minimum VGA value across all spaces \\
     & max\_value\_raw\_all & Maximum VGA value across all spaces \\
     & mean\_value\_raw\_all & Average VGA value across all spaces \\
     & std\_value\_raw\_all & Standard deviation of VGA values \\
    \hline
    \multirow{4}{*}{Living Room 2D} & mean\_value\_raw\_lv & Average VGA value in living room \\
     & min\_value\_raw\_lv & Minimum VGA value in living room \\
     & max\_value\_raw\_lv & Maximum VGA value in living room \\
     & std\_value\_raw\_lv & Standard deviation of VGA in living room \\
    \hline
...
and ceiling. Notably, all the VGA-based openness indicators from whole properties 
...
The overall VGA values of properties demonstrate high importance 
...
\subsubsection{Mean VGA Values - Whole Property}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.22\textwidth}
        ...
        \caption*{High VGA - Living Room 1}
    \end{subfigure}
    \begin{subfigure}[b]{0.22\textwidth}
    ...
    \begin{subfigure}[b]{0.22\textwidth}
        ...
        \caption*{High VGA - Living Room 2}
    \end{subfigure}
    ...
    \begin{subfigure}[b]{0.22\textwidth}
        ...
        \caption*{Low VGA - Living Room 2}
    \end{subfigure}
    \caption{Comparison of properties with high (top row) and low (bottom row) mean VGA values for entire property, showing both floor plans and corresponding living room images.}
    \label{fig:mean_vga_comparison}
\end{figure}

\subsubsection{Standard Deviation of VGA Values}
...
\begin{figure}[htbp]
    ...
    \end{subfigure}
    \caption{Comparison of properties with high (top row) and low (bottom row) VGA standard deviation values, demonstrating spatial diversity within properties with both floor plans and corresponding living room images.}
...
\subsubsection{High VGA with Low Window Ratio}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.22\textwidth}
        ...
        \caption*{High VGA Low Window - Floorplan 1}
    \end{subfigure}
    \begin{subfigure}[b]{0.22\textwidth}
        ...
        \caption*{High VGA Low Window - Interior 1}
    \end{subfigure}
    \begin{subfigure}[b]{0.22\textwidth}
        ...
        \caption*{High VGA Low Window - Floorplan 2}
    \end{subfigure}
    \begin{subfigure}[b]{0.22\textwidth}
        ...
        \caption*{High VGA Low Window - Interior 2}
    \end{subfigure}
    \caption{Properties with high mean VGA values but low window ratios, demonstrating 2D openness achieved through layout design rather than glazing with both floor plans and corresponding interior images.}
    \label{fig:high_vga_low_window}
\end{figure}

\subsubsection{High VGA with High Window Ratio}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.22\textwidth}
        ...
        \caption*{High VGA High Window - Floorplan 1}
    \end{subfigure}
    \begin{subfigure}[b]{0.22\textwidth}
        ...
        \caption*{High VGA High Window - Interior 1}
    \end{subfigure}
    \begin{subfigure}[b]{0.22\textwidth}
        ...
        \caption*{High VGA High Window - Floorplan 2}
    \end{subfigure}
    \begin{subfigure}[b]{0.22\textwidth}
        ...
        \caption*{High VGA High Window - Interior 2}
    \end{subfigure}
    \caption{Properties with both high mean VGA values and high window ratios, representing optimal combinations of 2D and 3D openness characteristics with both floor plans and corresponding interior images.}
    \label{fig:high_vga_high_window}
\end{figure}

\subsubsection{Low VGA with High Window Ratio}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.22\textwidth}
        ...
        \caption*{Low VGA High Window - Floorplan 1}
    \end{subfigure}
    \begin{subfigure}[b]{0.22\textwidth}
        ...
        \caption*{Low VGA High Window - Interior 1}
    \end{subfigure}
    \begin{subfigure}[b]{0.22\textwidth}
        ...
        \caption*{Low VGA High Window - Floorplan 2}
    \end{subfigure}
    \begin{subfigure}[b]{0.22\textwidth}
        ...
        \caption*{Low VGA High Window - Interior 2}
    \end{subfigure}
    \caption{Properties with low mean VGA values but high window ratios, showing how extensive glazing can provide openness despite compartmentalized layouts with both floor plans and corresponding interior images.}
    \label{fig:low_vga_high_window}
\end{figure}

\subsubsection{Low VGA with Low Window Ratio}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.22\textwidth}
        ...
        \caption*{Low VGA Low Window - Floorplan 1}
    \end{subfigure}
    \begin{subfigure}[b]{0.22\textwidth}
        ...
        \caption*{Low VGA Low Window - Interior 1}
    \end{subfigure}
    \begin{subfigure}[b]{0.22\textwidth}
        ...
        \caption*{Low VGA Low Window - Floorplan 2}
    \end{subfigure}
    \begin{subfigure}[b]{0.22\textwidth}
        ...
        \caption*{Low VGA Low Window - Interior 2}
    \end{subfigure}
    \caption{Properties with both low mean VGA values and low window ratios, representing the most enclosed characteristics with emphasis on privacy and separation with both floor plans and corresponding interior images.}
