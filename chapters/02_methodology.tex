...
\section{Spatial Openness Indicators}
...
\begin{itemize}
    ...
    \item \textbf{Architectural Elements}: The appearance of windows, ceilings, floors, and walls in photos of the living rooms in the LIFULL HOME's Dataset.
