...
The visibility determination between two points follows the isovist principle \cite{turner2001isovists}, where point $j$ is considered visible from point $i$ if the straight line connecting them does not intersect any wall boundaries in the floor plan.
